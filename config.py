...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "7481804342:AAHgbD9GlGYi6f3xCERo-BQ6xIh9u6cRfn8")
...
# NAMA OWNER
OWNER = os.environ.get("OWNER", "Hel")
...
#Database
DB_URI = os.environ.get("DATABASE_URL", ""mongodb+srv://DB1:DB1@db1.3ogvnqx.mongodb.net/?retryWrites=true&w=majority)
...
try:
    ADMINS=[1473392446]
    for x in (os.environ.get("ADMINS", "None").split()):
        ADMINS.append(int(x))
except ValueError:
